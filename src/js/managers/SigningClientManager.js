...
export class SigningClientManager {
  ...
  constructor(gameState) {
    ...
    window.txBankSend = this.queueMsgBankSend.bind(this);
    window.txAddressRegister = this.queueMsgAddressRegister.bind(this);
    window.txAddressRevoke = this.queueMsgAddressRevoke.bind(this);
    window.txFleetMove = this.queueMsgFleetMove.bind(this);

    window.txStructBuildComplete = this.queueMsgStructBuildComplete.bind(this);
    window.txStructOreMinerComplete = this.queueMsgStructOreMinerComplete.bind(this);
    window.txStructOreRefineryComplete = this.queueMsgStructOreRefineryComplete.bind(this);
    window.txAllocationCreate = this.queueMsgAllocationCreate.bind(this);
    window.txAllocationDelete = this.queueMsgAllocationDelete.bind(this);
    window.txAllocationUpdate = this.queueMsgAllocationUpdate.bind(this);
    window.txAllocationTransfer = this.queueMsgAllocationTransfer.bind(this);
    window.txGuildBankMint = this.queueMsgGuildBankMint.bind(this);
    window.txGuildBankRedeem = this.queueMsgGuildBankRedeem.bind(this);
    window.txGuildBankConfiscateAndBurn = this.queueMsgGuildBankConfiscateAndBurn.bind(this);
    window.txGuildUpdateEntrySubstationId = this.queueMsgGuildUpdateEntrySubstationId.bind(this);
    window.txGuildMembershipInvite = this.queueMsgGuildMembershipInvite.bind(this);
    window.txGuildMembershipInviteApprove = this.queueMsgGuildMembershipInviteApprove.bind(this);
    window.txGuildMembershipInviteDeny = this.queueMsgGuildMembershipInviteDeny.bind(this);
    window.txGuildMembershipInviteRevoke = this.queueMsgGuildMembershipInviteRevoke.bind(this);
    window.txGuildMembershipJoin = this.queueMsgGuildMembershipJoin.bind(this);
    window.txGuildMembershipKick = this.queueMsgGuildMembershipKick.bind(this);
    window.txGuildMembershipRequest = this.queueMsgGuildMembershipRequest.bind(this);
    window.txGuildMembershipRequestApprove = this.queueMsgGuildMembershipRequestApprove.bind(this);
    window.txGuildMembershipRequestDeny = this.queueMsgGuildMembershipRequestDeny.bind(this);
    window.txGuildMembershipRequestRevoke = this.queueMsgGuildMembershipRequestRevoke.bind(this);
    window.txPermissionGrantOnObject = this.queueMsgPermissionGrantOnObject.bind(this);
    window.txPermissionGrantOnAddress = this.queueMsgPermissionGrantOnAddress.bind(this);
    window.txPermissionRevokeOnObject = this.queueMsgPermissionRevokeOnObject.bind(this);
    window.txPermissionRevokeOnAddress = this.queueMsgPermissionRevokeOnAddress.bind(this);
    window.txPermissionSetOnObject = this.queueMsgPermissionSetOnObject.bind(this);
    window.txPermissionSetOnAddress = this.queueMsgPermissionSetOnAddress.bind(this);
    window.txPlanetExplore = this.queueMsgPlanetExplore.bind(this);
    window.txPlanetRaidComplete = this.queueMsgPlanetRaidComplete.bind(this);
    window.txPlayerSend = this.queueMsgPlayerSend.bind(this);
    window.txPlayerUpdatePrimaryAddress = this.queueMsgPlayerUpdatePrimaryAddress.bind(this);
    window.txPlayerResume = this.queueMsgPlayerResume.bind(this);
    window.txStructActivate = this.queueMsgStructActivate.bind(this);
    window.txStructDeactivate = this.queueMsgStructDeactivate.bind(this);
    window.txStructBuildInitiate = this.queueMsgStructBuildInitiate.bind(this);
    window.txStructBuildCancel = this.queueMsgStructBuildCancel.bind(this);
    window.txStructDefenseSet = this.queueMsgStructDefenseSet.bind(this);
    window.txStructDefenseClear = this.queueMsgStructDefenseClear.bind(this);
    window.txStructMove = this.queueMsgStructMove.bind(this);
    window.txStructAttack = this.queueMsgStructAttack.bind(this);
    window.txStructStealthActivate = this.queueMsgStructStealthActivate.bind(this);
    window.txStructStealthDeactivate = this.queueMsgStructStealthDeactivate.bind(this);
    window.txStructGeneratorInfuse = this.queueMsgStructGeneratorInfuse.bind(this);
    window.txSubstationCreate = this.queueMsgSubstationCreate.bind(this);
    window.txSubstationDelete = this.queueMsgSubstationDelete.bind(this);
    window.txSubstationAllocationConnect = this.queueMsgSubstationAllocationConnect.bind(this);
    window.txSubstationAllocationDisconnect = this.queueMsgSubstationAllocationDisconnect.bind(this);
    window.txSubstationPlayerConnect = this.queueMsgSubstationPlayerConnect.bind(this);
    window.txSubstationPlayerDisconnect = this.queueMsgSubstationPlayerDisconnect.bind(this);
    window.txSubstationPlayerMigrate = this.queueMsgSubstationPlayerMigrate.bind(this);
    window.txAgreementOpen = this.queueMsgAgreementOpen.bind(this);
    window.txAgreementClose = this.queueMsgAgreementClose.bind(this);
    window.txAgreementCapacityIncrease = this.queueMsgAgreementCapacityIncrease.bind(this);
    window.txAgreementCapacityDecrease = this.queueMsgAgreementCapacityDecrease.bind(this);
    window.txAgreementDurationIncrease = this.queueMsgAgreementDurationIncrease.bind(this);
    window.txProviderCreate = this.queueMsgProviderCreate.bind(this);
    window.txProviderWithdrawBalance = this.queueMsgProviderWithdrawBalance.bind(this);
    window.txProviderUpdateCapacityMinimum = this.queueMsgProviderUpdateCapacityMinimum.bind(this);
    window.txProviderUpdateCapacityMaximum = this.queueMsgProviderUpdateCapacityMaximum.bind(this);
    window.txProviderUpdateDurationMinimum = this.queueMsgProviderUpdateDurationMinimum.bind(this);
    window.txProviderUpdateDurationMaximum = this.queueMsgProviderUpdateDurationMaximum.bind(this);
    window.txProviderUpdateAccessPolicy = this.queueMsgProviderUpdateAccessPolicy.bind(this);
    window.txProviderGuildGrant = this.queueMsgProviderGuildGrant.bind(this);
    window.txProviderGuildRevoke = this.queueMsgProviderGuildRevoke.bind(this);
    window.txProviderDelete = this.queueMsgProviderDelete.bind(this);
    window.txReactorInfuse = this.queueMsgReactorInfuse.bind(this);
    window.txReactorBeginMigration = this.queueMsgReactorBeginMigration.bind(this);
    window.txReactorDefuse = this.queueMsgReactorDefuse.bind(this);
    window.txReactorCancelDefusion = this.queueMsgReactorCancelDefusion.bind(this);
